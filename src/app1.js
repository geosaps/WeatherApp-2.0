...
function getBigWeather (station) {
    $('.container3').slideUp(250);
    let appid = '3af5f670f8497198',
        openWeatherMap = 'http://api.wunderground.com/api/' + appid + '/conditions/' + station + '.json';
    $(document).ready(function(position) {
            $.getJSON(openWeatherMap, {
                ...
                let city = obj.observation_location.city,
                    country = obj.observation_location.country_iso3166,
                    alt = obj.observation_location.elevation,
                    long = obj.observation_location.longitude,
                    lat = obj.observation_location.latitude,
